...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Card title chip (entire title element) — flush top-left corner */
      .card .card-title {
        display: inline-flex;
        align-items: center;
        gap: 0.5rem;
    ...
    <img src="https://cdn.calebgruber.me/CalebGruber..png" alt="Logo" height="36">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item active" href="./all-elements.html" aria-current="page"> All Elements </a>
      ...
      <div class="page-wrapper">
        ...
        <main id="content" class="page-body">
          <div class="container-xl">
            <div class="row row-cards ui-template-match">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-3">
                      <div>
                        <h2 class="mb-1">Single-page UI test surface</h2>
                      ...
                      <div class="ms-lg-auto">
                        <div class="btn-list">
                          <a href="#content" class="btn btn-primary">Jump to content</a>
                          <button class="btn btn-outline-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-demo">Open offcanvas</button>
                          <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modal-demo">Open modal</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="alert alert-info" role="alert">
                      ...
                      <div class="alert-text">This is a primary alert with an icon.</div>
                    </div>
                    <div class="alert alert-success" role="alert">
                      ...
                      <div class="alert-text">This is a success alert message.</div>
                    </div>
                    <div class="alert alert-warning" role="alert">
                      ...
                      <div class="alert-text">This is a warning alert message.</div>
                    </div>
                    <div class="alert alert-danger" role="alert">
                      ...
                      <div class="alert-text">This is a danger alert message.</div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <h3 class="card-title">
                      <span class="card-title-icon"
                        ...
                        >
                          ...
                          <path d="M14 7l6 0" />
                          <path d="M17 4l0 6" /></svg></span
                      ><span>Segmented Navigation</span>
                    </h3>
                  </div>
                  <div class="card-body">
                  ...
                  <div class="card-body">
                    <div class="row row-cards">
                      <div class="col-md-6 col-xl-3">
                        ...
                        <div class="input-icon">
                          <input class="form-control" placeholder="Select a date" id="datepicker-ui-test-date" value="2026-05-15" />
                          <span class="input-icon-addon"
                            ><!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div class="col-md-6 col-xl-3">
                        ...
                        <input type="text" class="form-control d-block" id="colorpicker-ui-test-color" value="#206bc4" />
                      </div>
                      <div class="col-md-6 col-xl-3">
                        <label class="form-label">Enhanced select</label>
                        <select class="form-select" id="select-ui-test-select" value="">
                      ...
                      <div class="col-md-6 col-xl-3">
                        ...
                        <textarea class="form-control" data-bs-toggle="autosize" rows="2">
This textarea grows automatically when you type more content into it.</textarea
                        >
                      </div>
                      <div class="col-12">
                        <label class="form-label">File upload</label>
                        <form class="dropzone" id="dropzone-ui-test-dropzone" action="./" autocomplete="off" novalidate>
                          <div class="fallback">
                            <input name="file" type="file" />
                          </div>
                          <div class="dz-message">
                            <h3 class="dropzone-msg-title">Drop files here</h3>
                            <span class="dropzone-msg-desc">Drag and drop or click to upload</span>
                          </div>
                        </form>
                      </div>
                    </div>
              ...
              <div class="col-xl-6">
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <div class="row row-cards">
                      <div class="col-12">
                        <div id="chart-ui-test-chart" class="position-relative chart-lg"></div>
                      </div>
                      <div class="col-12">
                    ...
                    <h3 class="card-title">
                      <span class="card-title-icon"
                        ...
                        >
                          ...
                          <path d="M14 7l6 0" />
                          <path d="M17 4l0 6" /></svg></span
                      ><span>Calendar & Carousel</span>
                    </h3>
                  </div>
                  <div class="card-body">
                    <div class="mb-4">
                      <div id="calendar-ui-test-calendar"></div>
                    </div>
                    <div id="carousel-ui-test-carousel" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carousel-ui-test-carousel" data-bs-slide-to="0" class="active"></button>
                        <button type="button" data-bs-target="#carousel-ui-test-carousel" data-bs-slide-to="1" class=""></button>
                        <button type="button" data-bs-target="#carousel-ui-test-carousel" data-bs-slide-to="2" class=""></button>
                      </div>
                      ...
                      <a class="carousel-control-prev" href="#carousel-ui-test-carousel" role="button" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                      </a>
                      <a class="carousel-control-next" href="#carousel-ui-test-carousel" role="button" data-bs-slide="next">
                    ...
                    <h3 class="card-title">
                      <span class="card-title-icon"
                        ...
                        >
                          ...
                          <path d="M14 7l6 0" />
                          <path d="M17 4l0 6" /></svg></span
                      ><span>Rich Text & Signature</span>
                    </h3>
                  </div>
                  <div class="card-body">
                    <div class="mb-4">
                      <form method="post">
                        <textarea id="hugerte-ui-test-editor">Hello, <b>Tabler</b>!</textarea>
                      </form>
                    </div>
                    <div class="signature position-relative border rounded p-3">
                      <div class="position-absolute top-0 end-0 p-2">
                        <div class="btn btn-icon" id="signature-ui-test-signature-clear" title="Clear signature" data-bs-toggle="tooltip">
                          <!-- Download SVG icon from http://tabler.io/icons/icon/trash -->
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      <canvas id="signature-ui-test-signature" width="400" height="220" class="signature-canvas"></canvas>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6">
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <div class="mb-4">
                      <div id="player-ui-test-player" data-plyr-provider="youtube" data-plyr-embed-id="dQw4w9WgXcQ"></div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-vcenter table-mobile-md">
                        ...
                        <tbody>
                          <tr>
                            <td data-label="Name">
                              <div class="d-flex py-1 align-items-center">
                                <span class="avatar avatar-2 me-2" style="background-image: url(./static/avatars/000m.jpg)"> </span>
                                <div class="flex-fill">
                                  <div class="fw-medium">Paweł Kuna</div>
                                  <div class="text-secondary"><a href="#" class="text-reset">paweluna@howstuffworks.com</a></div>
                                </div>
                              </div>
                            </td>
                            <td data-label="Title">
                              <div>UI Designer</div>
                              <div class="text-secondary">Training</div>
                            </td>
                          ...
                          <tr>
                            <td data-label="Name">
                              <div class="d-flex py-1 align-items-center">
                                <span class="avatar avatar-2 me-2" style="background-image: url(./static/avatars/052f.jpg)"> </span>
                                <div class="flex-fill">
                                  <div class="fw-medium">Jeffie Lewzey</div>
                                  <div class="text-secondary"><a href="#" class="text-reset">jlewzey1@seesaa.net</a></div>
                                </div>
                              </div>
                            </td>
                            <td data-label="Title">
                          ...
                          <tr>
                            <td data-label="Name">
                              <div class="d-flex py-1 align-items-center">
                                <span class="avatar avatar-2 me-2" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                                <div class="flex-fill">
                                  <div class="fw-medium">Mallory Hulme</div>
                                  <div class="text-secondary"><a href="#" class="text-reset">mhulme2@domainmarket.com</a></div>
                                </div>
                              </div>
                            </td>
                            <td data-label="Title">
                              <div>Geologist IV</div>
                              <div class="text-secondary">Support</div>
                            </td>
                            <td class="text-secondary" data-label="Role">User</td>
                            <td>
                          ...
                          <tr>
                            <td data-label="Name">
                              <div class="d-flex py-1 align-items-center">
                                <span class="avatar avatar-2 me-2" style="background-image: url(./static/avatars/003m.jpg)"> </span>
                                <div class="flex-fill">
                                  <div class="fw-medium">Dunn Slane</div>
                                  <div class="text-secondary"><a href="#" class="text-reset">dslane3@epa.gov</a></div>
                                </div>
                              </div>
                            </td>
                            <td data-label="Title">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-demo" aria-labelledby="offcanvas-demo-label">
              <div class="offcanvas-header">
                <h2 class="offcanvas-title" id="offcanvas-demo-label">Offcanvas panel</h2>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
              </div>
              <div class="offcanvas-body">
                <div class="space-y">
                  <p class="text-secondary">This panel gives the UI test page an offcanvas target for interaction checks.</p>
                  <a href="#" class="btn btn-primary btn-2"> Primary action </a>
                  <div class="progress progress-3">
                    <div
                  ...
                  <div class="alert alert-info" role="alert">
                    ...
                    <div class="alert-text">Offcanvas content is visible and interactive.</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-ui-test-date"),
            buttonText: {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect &&
          new TomSelect((el = document.getElementById("select-ui-test-select")), {
            copyClassesToDropdown: false,
            dropdownParent: "body",
            controlInput: "<input>",
            render: {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        new Dropzone("#dropzone-ui-test-dropzone");
      });
    </script>
    <style>
      :root {
        --chart-ui-test-chart-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-ui-test-chart-color-1: color-mix(in srgb, transparent, var(--tblr-primary) 80%);
        --chart-ui-test-chart-color-2: color-mix(in srgb, transparent, var(--tblr-green) 80%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-ui-test-chart"), {
            chart: {
              type: "bar",
              fontFamily: "inherit",
              height: 240,
            ...
            colors: ["var(--chart-ui-test-chart-color-0)", "var(--chart-ui-test-chart-color-1)", "var(--chart-ui-test-chart-color-2)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        var calendarEl = document.getElementById("calendar-ui-test-calendar");
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        let options = {
          selector: "#hugerte-ui-test-editor",
          height: 300,
          menubar: false,
          statusbar: false,
          plugins: [
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        const canvas = document.getElementById("signature-ui-test-signature");
        if (canvas) {
          const signaturePad = new SignaturePad(canvas, {
            backgroundColor: "transparent",
            penColor: getComputedStyle(canvas).color,
          });
          document.querySelector("#signature-ui-test-signature-clear").addEventListener("click", function () {
            signaturePad.clear();
          });
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Plyr && new Plyr("#player-ui-test-player");
      });
    </script>
    <script>
      /*
